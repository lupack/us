...
class CartController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $user = DB::table('user')
            ...
            ->select('orders.id','orders.user_id','orders.count','orders.sum','orders.count','orders.rec','orders.tel','orders.addr','orders.staus','orders.umsg','orders.create_time','user.username');
...
//            $goods[] = DB::table('goods')->where('id',$value)->first();
        ...
        return view('home.cart.add',['goods'=>$goods, 'total' => $totals, 'addresses' => $addresses, 'count' => $count]);
    }   
     /**
     * Store a newly created resource in storage.
     *
