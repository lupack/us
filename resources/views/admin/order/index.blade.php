            ...
            <table class="mws-datatable-fn mws-table">
                ...
                @foreach($order as $v)
                    <tr>
                        ...
                        <td>
                            <button class="icol-delivery"></button>
                        </td>>
                        <td>
                            <span class="btn-group">
                                <a href="/admin/cate/edit" class="btn btn-small"><i class="icon-pencil"></i></a>

                            <form action="/admin/cate/" method='post' style='display:inline'>
                                {{csrf_field()}}
