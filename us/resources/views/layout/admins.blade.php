...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="./index.html">星梦网购城</a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
            <img src="/admins/images/bg.png" alt="" width="30px" height="30px">
          <li class="layui-nav-item">
            <a href="javascript:;">admin</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a onclick="x_admin_show('个人信息','http://www.baidu.com')">修改头像</a></dd>
        ...
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
          ...
          <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <!-- <iframe  frameborder="0" scrolling="yes" class="x-iframe"> -->
                @section('content')
