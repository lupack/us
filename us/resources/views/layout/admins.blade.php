...
<header class="navbar-wrapper">
  <div class="navbar navbar-fixed-top" style="background-color:#bdc3c7">
    <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">星梦网购城</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml"></a>
    ...
    <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
      <ul class="cl">
        ...
        <li id="Hui-msg"><img src="/admins/admin-login-bg.jpg" alt="" width="38" height="38"></li>
...
<aside class="Hui-aside">
  <div class="menu_dropdown bk_2">
    <dl id="menu-article">
      <dt><i class="Hui-iconfont">&#xe616;</i>后台首页</dt>
  </dl>
    <dl id="menu-picture">
...
<section class="Hui-article-box">
  ...
  <div id="iframe_box" class="Hui-article">
    <div class="show_iframe">
      ...
      @show<!-- <iframe scrolling="yes" frameborder="0" src="welcome.html"></iframe> -->
  </div>
  </div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/admins/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
<script type="text/javascript" src="/admins/lib/jquery/1.9.1/jquery.min.js"></script>
<script type="text/javascript" src="/admins/static/h-ui/js/H-ui.min.js"></script>
