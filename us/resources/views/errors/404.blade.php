    ...
    <section id="error-container">
        ...
        <div class="block-error">
            ...
            <header>
                ...
                <p class="text-center">页面消失了</p>
            </header>

            <p class="text-center">Houston, we have a problem. We're having trouble loading the page you are looking for.</p>
            <div class="row">
                <div class="col-md-6">
                    <a class="btn btn-info btn-block btn-3d" href="index.blade.php">返回首页</a>
                </div>
                <div class="col-md-6">
                    <button class="btn btn-primary btn-block btn-3d" onclick="history.back();">后退一步</button>
                </div>
            </div>
        </div>
