...
<!-- start banner_x -->
        <div class="banner_x center">
            <a href="/home/cart" target="_blank"><div class="logo fl"></div></a>
        ...
        <div class="gwcxqbj">
            <div class="gwcxd center">
                ...
                <div class="content2 center">
                    ...
                    @if($v->goods_id == $val->id)
                    <div class="sub_content fl"><img src="/home/image/gwc_xiaomi6.jpg"></div>
                    <div class="sub_content fl">{{$val->gname}}</div>
                    <div class="sub_content fl" style="position:relative;left: 13px;">{{$val->price}}元</div>
                    @endif
                    @endforeach
                    <div class="sub_content fl">
            ...
            <div class="jiesuandan mt20 center">
                <div class="tishi fl ml20">
                    <ul>
                        <li><a href="/home/liebiao.html">继续购物</a></li>
                        <li>|</li>
