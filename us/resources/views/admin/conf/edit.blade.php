...
@section('content')
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/admin/conf/{{$res->id}}" method="post" enctype="multipart/form-data" id="mws">
            <div class="mws-form-inline">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="small" title="" name="keyword" value="{{$res['keyword']}}">
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                        ...
                        <div class="mws-form-item clearfix">
                            <ul class="mws-form-list inline">
                                ...
                                <li><label><input type="radio" name='status' value="2" @if($res->status== 0) checked @endif>关闭</label></li>
                            </ul>
                        </div>
                    </div>
                </div>
